...
import 'package:rick_and_morty/feature/data/datasources/person_loca_datasource.dart';
...
import 'package:rick_and_morty/feature/presentation/block/person_list_cubit/person_list_cubit.dart';
import 'package:rick_and_morty/feature/presentation/block/search_bloc/search_bloc.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton<NetworkInfo>(
    () => NetworkInfoImpl(sl())//NetworkInfoImp(sl()),
  );
